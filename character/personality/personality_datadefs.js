...
var personalityCoreDataDef = {
	...
	fields:{
		...
		//not calm
		empathy:{				type:"norm",	min:0, max:1 },
		sympathy:{				type:"norm",	min:0, max:1 },
		//Feelings of pity and sorrow for someone else's misfortune.
		sociability:{			type:"norm",	min:0, max:1 },
		//Willing to talk and engage in activities with other people; friendly.
		honour:{				type:"norm",	min:0, max:1 }
...
var personalityDataDef = {
	...
	fields:{
		...
		extraversion:{			type:"norm",	min:0, max:1 },
		...
		stable:{				type:"norm",	min:0, max:1 },
		//sane and sensible; not easily upset or disturbed.
		guilt:{					type:"norm",	min:0, max:1 },
		
		//*** OPTIMISM ***
		optimism:{				type:"norm",	min:0, max:1 },
		//Hopefulness and confidence about the future or the success of something.
		//Sources:
		//Confidence in your own actions.
		//Belief you will succeed?
		//Willpower? Ego?
		selfConfidence:{		type:"norm",	min:0, max:1 },
		//a feeling of trust in one's abilities, qualities, and judgement.
		//Perhaps not dependent on optimism (which is general)
		depression:{			type:"norm",	min:0, max:1 },
		arrogance:{				type:"norm",	min:0, max:1 },
		//Having or revealing an exaggerated sense of one's own importance or abilities.
		//confidence mixed with something else?
		joyful:{				type:"norm",	min:0, max:1 },
		playful:{				type:"norm",	min:0, max:1 },
		//fond of games and amusement; light-hearted

		//*** EGO ***
		vanity:{				type:"norm",	min:0, max:1 },
		//Excessive pride in or admiration of one's own appearance or achievements.
		//narcissism
		//Depends on love for self? Ego?
		ambition:{				type:"norm",	min:0, max:1 },
		//having a strong desire for success or achievement
		selfWorth:{				type:"norm",	min:0, max:1 },
		//self esteem, ego?
		sensitive:{				type:"norm",	min:0, max:1 },
		//easily offended or upset.
		controlling:{			type:"norm",	min:0, max:1 }		
	}
}
