...
var generator = {
	...
	inputs:{
		...
		fields:[
			...
			{ name:"name", type:"data_def", default_id:"df22de14-e904-496f-8ff0-70f7e820c8f6", id:"93c7d5da-936f-4d75-8fea-1d599f233244" },
		],
	},
	outputs:{
		name:"outputs",
	...
	{		
		...
		outputs.data = bg.BuildDataDefValues(inputs.name.fields, inputs.seed);
