var planetDataDef = {
	...
	fields:{
		...
		age:{				type:"time",			units:"my", 		min:0,		max:1000000},
		//composition (gas/rock)
		//List of layers?
		//orbit
		averageOrbitDistance:{	type:"distance", 	units:"km",		min:58000000,	max:5900000000}, //min, bit less than mercury. max about pluto dist.
		timeToCompleteOrbit:{	type:"time",		units:"years",	min:0.01,		max:1000 },
		//temp
		//exposure to space (meteors etc)
		//sea level
		gravity:{				type:"accel",	units:"m/s", 	min:0.8, 		max:1.2 },
		approxMass:{			type:"mass",	units:"earths", min:0.1, 		max:1000 }	//Thinking of using '1 earth' as a unit becuase the number is too big in kg! About 5.9736 x 10^24 kg
		//weather
	}
};
